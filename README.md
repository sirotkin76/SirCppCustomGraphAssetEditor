...
4. Функция **SirCppFindNodeGetAttrData00**
...
5. Атрибут **OutputTags** - Массив тегов, которые разработчик задал на выходе ноды.
...
6. Функция **SirCppFindNodeGetAttrData00_UseTag**
...
**ВАЖНО**: Тег ответа должен быть уникальным. Так как логика функции находит первый похожий тег и даёт возможность получить данные именно первого.
